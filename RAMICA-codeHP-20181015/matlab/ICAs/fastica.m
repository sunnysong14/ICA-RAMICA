...
stabilization     = 'off';
epsilon           = 0.0001;
maxNumIterations  = 1000;  %<-- Original set is 1000, but some ICs do not converge.
maxFinetune       = 5;
initState         = 'rand';  %<--initial guess or random initial state. See in fpica()
guess             = 0;
sampleSize        = 1;
displayMode       = 'off';
displayInterval   = 1;
...
b_verbose = 0;  %<-- Liyan set to 0
jumpPCA = 0;
jumpWhitening = 0;
only = 3;  %<-- always using ICA
userNumOfIC = 0;
